...
| `pip-and-cadence-methods` | Desktop + GitHub, private | Sanitized, shareable version of PIP (Juan's PM orchestrator) + the FORJA methodology | Independent of this library; the real PIP lives only on Juan's work Mac |
